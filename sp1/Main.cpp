...
public:
	...
	{
		const auto itr = typeMap.find(str);
		if (itr == typeMap.end())
		{
...
{
	const OptParser options{argc, argv};
	const auto loader = std::make_unique<DataLoader>();
